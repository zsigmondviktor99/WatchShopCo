...
namespace webshop_gyakorlas.Data.Migrations
{
    public partial class AddAdminUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            INSERT INTO[dbo].[AspNetUsers] ([Id], [UserName], [NormalizedUserName], [Email], [NormalizedEmail], [EmailConfirmed], [PasswordHash], [SecurityStamp], [ConcurrencyStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount]) VALUES(N'e322ca0d-1130-42d5-be93-e6acf71a16fc', N'admin@watchshopco.com', N'ADMIN@WATCHSHOPCO.COM', N'admin@watchshopco.com', N'ADMIN@WATCHSHOPCO.COM', 1, N'AQAAAAEAACcQAAAAEBJG/0kxy9OLI+Cm1fhttTkhsgK50MAyC33WpcEsI9alrR+OyDQDan5ffyZLEwDolg==', N'BJTPCGWNQMPKEVTGNREL3CFRK3NP2Y3T', N'4daaf49c-22b5-483f-a50b-c3f3dbab3a7f', NULL, 0, 0, NULL, 1, 0)
